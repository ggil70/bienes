...
class ReporteBienGrupoListadoRender(models.AbstractModel):
    _name = "report.bienes.bien_grupo_listado_render"
    ...
    def _get_report_values(self, docids, data):
        ...
        titulo = "LISTADO DE BIENES POR GRUPO"
        return {
            'docs': data['grupo_data'],
            'grupo':data["grupo"],
